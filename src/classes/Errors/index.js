...
/**
 * SpartanTokenError Class
 */
export default class SpartanTokenError extends Error
{
    /**
     * @return {Object}
     */
    ...
    constructor(error = [], additionalParameters = {}) {
        ...
        Object.setPrototypeOf(this, SpartanTokenError.prototype);
        this.name = this.constructor.name;

        SpartanTokenError.lastError = {
            code: error.code,
            status: error.status,
    ...
    getFormatedError = () => {
        ...
        const error = SpartanTokenError.lastError;
        let formated = {};
